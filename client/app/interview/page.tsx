    ...
    <div className="min-h-screen bg-[#050816] p-8">
      ...
      {!finished && (
        <button
          ...
          disabled={loading}
          className="bg-purple-600 px-6 py-3 rounded-xl text-white disabled:opacity-60"
        >
          {loading && !started
            ? "Generating..."
            : started
      ...
      {started && !finished && question && (
        <div className="mt-8 max-w-3xl bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <textarea
            ...
            disabled={!!feedback}
            className="mt-6 w-full h-40 bg-black/20 border border-white/10 rounded-xl p-4 text-white disabled:opacity-60"
          />
          ...
          {!feedback ? (
            <button
              ...
              disabled={loading}
              className="mt-5 bg-blue-600 px-6 py-3 rounded-xl text-white cursor-pointer hover:bg-blue-700 disabled:opacity-60"
            >
            ...
            <button
              ...
              className="mt-5 bg-purple-600 px-6 py-3 rounded-xl text-white cursor-pointer hover:bg-purple-700"
            >
      ...
      {feedback && !finished && (
        <div className="mt-8 max-w-3xl bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <p className="text-gray-300 mt-4">{feedback.feedback}</p>
      ...
      {finished && scores.length > 0 && (
        <div className="mt-8 max-w-3xl bg-purple-500/10 border border-purple-500/20 rounded-3xl p-8">
          ...
          <div className="flex gap-4 mt-6">
            <button
              onClick={generateQuestion}
              className="bg-purple-600 px-6 py-3 rounded-xl text-white hover:bg-purple-700"
            >
              Practice Again
            </button>
            ...
            <button
              ...
              className="bg-white/10 border border-white/10 px-6 py-3 rounded-xl text-white hover:bg-white/20"
            >
              View History
            </button>
          </div>
